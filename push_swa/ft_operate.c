...
/*   Updated: 2021/03/15 11:57:41 by nepage-l         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

int		ft_restart(t_stack tempa, t_stack tempb, t_stack *a, t_stack *b)
{
...
int		ft_test(t_stack *a, t_stack *b, int nb, t_fct *fct)
{
	...
	while (1 && ft_restart(tempa, tempb, a, b) && ft_gars(taba, tabb, a, b))
	{
		if (!temp)
			return (0);
